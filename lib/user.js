...
User.prototype.request = function(api, params, to) {
  params = params || {};

  var self = this;
  var method = api.method.toLowerCase();
  var path = utils.formatPath(self.props, api.path, params.path_params, 
      api.query, params.query_params, to);
  var params = utils.formatParams(self.props, api.parameters, params.data_params, to);
